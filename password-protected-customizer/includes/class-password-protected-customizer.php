...
class Password_Protected_Customizer {
	...
	/**
	 * The base url to the plugin.
	 *
	 * @since    1.0.0
	 * @access   private
	 * @var      string    $base_url    The base url to the plugin.
	 */
    private $base_url;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-password-protected-customizer-loader.php';

		/**
		 * The class responsible for loading the specific template file
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-password-protected-customizer-template-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-password-protected-customizer-public.php';

		$this->loader = new Password_Protected_Customizer_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Password_Protected_Customizer_i18n();
	...
	/**
	 * Retrieve the base url of the plugin.
	 *
	 * @since     1.0.0
    ...
    public function get_login_url() {
        ...
        return $Password_Protected->login_url();
    }
	
	/**
	 * Retrieve login errors.
	 *
	 * @since     1.0.0
	 * @return    string    The login errors.
	 */
    public function get_login_errors() {
        global $Password_Protected;
        return $Password_Protected->errors->get_error_code();
    }
